                        ...
                        <div class="card-body p-0">
                            <div class="p-4">
                                ...
                                @endif
                                    @csrf
                                    <div class="mb-3">
                                        <label class="form-label" for="emailTextarea">Email</label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="nameTextarea">Name</label>
                                    ...
                                    @else
                                    <div class="mb-3">
                                        <label class="form-label" for="passwordTextarea">Password</label>
