        ...
        Route::group(['middleware' => ['auth:api', 'auth.active']], function () {
            Route::group(['prefix' => 'tests'], function () {
                ...
                Route::group(['prefix' => 'histories'], function () {
                    Route::get('/immediate', [TestController::class, 'getImmediateSkillResultAfterCompleteTest']);
                    Route::get('/immediate/{skillId}', [TestController::class, 'getImmediateSkillDetailAfterCompleteTest']);
                    Route::get('/', [TestController::class, 'getTestHistories']);  // list of tests
                    Route::get('/{id}', [TestController::class, 'getDetailTestHistory']);  // the list of exams belongs to the above test ~ submitted
